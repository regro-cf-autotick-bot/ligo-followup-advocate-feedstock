...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ligo-followup-advocate-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ligo-followup-advocate-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add ligo-followup-advocate
# for installing globally
pixi global install ligo-followup-advocate
```
...
It is possible to list all of the versions of `ligo-followup-advocate` available on your platform:
...
```
pixi search ligo-followup-advocate --channel conda-forge
```
